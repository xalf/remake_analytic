...
const LoginSchema = z.object({
  ...
  password: z
    ...
    .max(15, "Пароль должен быть меньше 15 символов"),
});

export async function loginAction(
  previosState: LoginErrorState | undefined,
  form: FormData,
): Promise<LoginErrorState | undefined> {
  ...
  cookieStore.set("X_ACCESS_TOKEN", authTokens.access_token, {
    httpOnly: true,
    maxAge: 6600,
  });
  cookieStore.set("X_REFRESH_TOKEN", authTokens.refresh_token, {
    httpOnly: true,
    maxAge: 594000,
  });
